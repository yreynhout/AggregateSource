...
namespace StreamSource {
  ...
  public class EventStreamTests {
    ...
    [Datapoint]
    public IEnumerable<object> NoEvents = new object[0];

    [Datapoint]
    public IEnumerable<object> OneEvent = new [] { new object() };

    [Datapoint]
    public IEnumerable<object> TwoEvents = new [] { new object(), new object() };
