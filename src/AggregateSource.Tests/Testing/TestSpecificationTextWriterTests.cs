...
namespace AggregateSource.Testing {
  ...
  public class TestSpecificationTextWriterTests : TestSpecificationDataPointFixture {
    ...
    public void WriteExceptionCentricTestSpecificationResultsInExpectedOutput(ExceptionCentricTestSpecification specification, string result) {
    ...
    public void WriteEventCentricTestSpecificationResultsInExpectedOutput(EventCentricTestSpecification specification, string result) {
      using (var writer = new StringWriter()) {
        var sut = new TestSpecificationTextWriter(writer);
