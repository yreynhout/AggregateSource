...
namespace AggregateSource.Testing
{
    ...
    {
        [Datapoint] public Tuple<string, object>[] NoEvents = new Tuple<string, object>[0];

        [Datapoint] public Tuple<string, object>[] OneEvent = new[]
        {new Tuple<string, object>("Aggregate/" + Guid.NewGuid(), new object())};

        [Datapoint] public Tuple<string, object>[] TwoEventsOfDifferentSources = new[]
        {
            new Tuple<string, object>("Aggregate/" + Guid.NewGuid(), new object()),
            new Tuple<string, object>("Aggregate/" + Guid.NewGuid(), new object()),
        };

        [Datapoint] public Tuple<string, object>[] TwoEventsOfTheSameSource = new[]
        {
