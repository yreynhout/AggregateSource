    ...
    namespace Messaging {
      ...
      public class AddedNewItemToTodoList : IEvent {
        protected bool Equals(AddedNewItemToTodoList other) {
          return Id.Equals(other.Id) && TodoListItemId.Equals(other.TodoListItemId) && string.Equals(Description, other.Description);
        }
        ...
        public override int GetHashCode() {
          return Id.GetHashCode() ^ TodoListItemId.GetHashCode() ^ (Description != null ? Description.GetHashCode() : 0);
        }
