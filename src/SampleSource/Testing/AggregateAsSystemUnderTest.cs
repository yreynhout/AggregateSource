...
namespace SampleSource.Testing {
  namespace AggregateAsSystemUnderTest {
    ...
    public static class NUnitExtensions {
      ...
      public static void AssertThrows<TException>(this IAggregateFactoryWhenStateBuilder builder, TException exception) where TException : Exception {
      ...
      public static void AssertThrows<TException>(this IAggregateCommandWhenStateBuilder builder, TException exception) where TException : Exception {
        var specification = builder.Throws(exception).Build();
        var sut = specification.SutFactory();
        sut.Initialize(specification.Givens);
        NUnit.Framework.Assert.That(
      ...
      public static void AssertThrows<TResult, TException>(this IAggregateQueryWhenStateBuilder<TResult> builder, TException exception) where TException : Exception {
        var specification = builder.Throws(exception).Build();
        var sut = specification.SutFactory();
        sut.Initialize(specification.Givens);
        NUnit.Framework.Assert.That(
    ...
    namespace Ticketing {
      ...
      public class Concert : AggregateRootEntity {
        ...
        public TicketSale StartTicketSale(TicketSaleId ticketSaleId, DateTimeOffset date) {
          if(_cancelled)
            throw new InvalidOperationException("Starting a ticket sale for a cancelled concert is impossible.");
    ...
    namespace Messaging {
      ...
      public static class TicketSaleEvents {
        public static TicketSaleStartedEvent Started(Guid ticketSaleId, Guid concertId, DateTimeOffset date, int seatCount) {
      ...
      public class TicketSaleStartedEvent {
        protected bool Equals(TicketSaleStartedEvent other) {
          return TicketSaleId.Equals(other.TicketSaleId) && ConcertId.Equals(other.ConcertId) && Date.Equals(other.Date);
        }
