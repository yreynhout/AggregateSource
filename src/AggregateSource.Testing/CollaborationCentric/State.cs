...
namespace AggregateSource.Testing.CollaborationCentric
{
    ...
    public class State
    {
        ...
        State(Tuple<string, object>[] facts)
        {
            _facts = facts;
        }
        ...
        public State Fact(string identifier, params object[] events)
        {
            ...
            return new State(combinedFacts);
        }
        ...
        public State Facts(params Tuple<string, object>[] facts)
        {
        ...
        public static implicit operator Tuple<string, object>[](State batch)
        {
            return batch._facts;
        }
    }
