...
namespace StreamSource {
  ...
  public class OptimisticConcurrencyExceptionTests {
    ...
    private const Int32 ExpectedVersion = 123;

    [Test]
    public void IsStreamSourceException() {
      Assert.That(new OptimisticConcurrencyException(StreamId, ExpectedVersion), Is.InstanceOf<StreamSourceException>());
    }
    ...
    [Test]
    public void UsingConstructorWithStreamIdAndExpectedVersionAndMessageAndInnerExceptionReturnsExceptionWithExcpectedProperties() {
