    ...
    namespace RepositoryTests
    {
        ...
        public class Construction
        {
            ...
            public void UnitOfWorkCanNotBeNull()
            {
                Assert.Throws<ArgumentNullException>(
                    () =>
                    new Repository<AggregateRootEntityStub>(AggregateRootEntityStub.Factory, null,
                                                            EventStreamReaderStub.Instance));
            }
        ...
        public class AnyInstance
        {
            ...
            public void SetUp()
            {
                _sut = new Repository<AggregateRootEntityStub>(() => null, new UnitOfWork(),
                                                               EventStreamReaderStub.Instance);
            }
