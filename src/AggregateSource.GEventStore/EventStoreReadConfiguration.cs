...
namespace AggregateSource.GEventStore {
  ...
  public class EventStoreReadConfiguration {
    ...
    public EventStoreReadConfiguration(SliceSize sliceSize, IEventDeserializer deserializer, IStreamNameResolver streamNameResolver, IStreamUserCredentialsResolver streamUserCredentialsResolver) {
