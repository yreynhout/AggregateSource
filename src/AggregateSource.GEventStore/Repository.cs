...
namespace AggregateSource.GEventStore {
  ...
  public class Repository<TAggregateRoot> : IRepository<TAggregateRoot> where TAggregateRoot : IAggregateRootEntity {
    ...
    public Repository(Func<TAggregateRoot> rootFactory, UnitOfWork unitOfWork, IEventStoreConnection connection, EventStoreReadConfiguration configuration) {
    ...
    public Optional<TAggregateRoot> GetOptional(string identifier) {
      ...
      var slice = _connection.ReadStreamEventsForward(streamName, 1, _configuration.SliceSize, false, streamUserCredentials);
