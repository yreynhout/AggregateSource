...
namespace AggregateSource.GEventStore.Snapshots {
  ...
  public class SnapshotReaderConfiguration {
    ...
    public SnapshotReaderConfiguration(ISnapshotDeserializer deserializer, IStreamNameResolver streamNameResolver, IStreamUserCredentialsResolver streamUserCredentialsResolver) {
