...
namespace SSS.Snapshots
{
    namespace SnapshotableRepositoryTests
    {
        ...
        public class WithEmptyStoreAndEmptyUnitOfWorkAndNoSnapshot
        {
            ...
            {
                var exception =
                    Assert.Throws<AggregateNotFoundException>(() => _sut.GetAsync(_model.UnknownIdentifier));
            ...
            {
                var result = _sut.GetOptionalAsync(_model.UnknownIdentifier);
        ...
        public class WithEmptyStoreAndFilledUnitOfWorkAndNoSnapshot
        {
            ...
            {
                var result = _sut.GetAsync(_model.KnownIdentifier);
            ...
            {
                var result = _sut.GetOptionalAsync(_model.KnownIdentifier);
