namespace AggregateSource.GEventStore.Builders {
  public class EventReaderConfigurationBuilder {
    ...
    public EventReaderConfigurationBuilder UsingSliceSize(SliceSize value) {
      return new EventReaderConfigurationBuilder(value, _deserializer, _streamNameResolver, _streamUserCredentialsResolver);
    }

    public EventReaderConfigurationBuilder UsingDeserializer(IEventDeserializer value) {
      return new EventReaderConfigurationBuilder(_sliceSize,value, _streamNameResolver, _streamUserCredentialsResolver);
    }
    ...
    public EventReaderConfiguration Build() {
      return new EventReaderConfiguration(_sliceSize, _deserializer, _streamNameResolver, _streamUserCredentialsResolver);
    }
