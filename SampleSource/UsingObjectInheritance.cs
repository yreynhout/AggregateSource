  ...
  namespace UsingObjectInheritance {
    ...
    public class BarCode {
      ...
      public BarCode(string value) {
        ...
        if (value.Any(@char => !@char.IsHexSymbol()))
          throw new ArgumentOutOfRangeException("value", "The value of a barcode should consist of hexadecimal characters only.");
        _value = value;
      }
    ...
    namespace Messaging {
      ...
      public class RentedVideoTape {
        ...
        public RentedVideoTape(Guid videoTapeId, Guid videoTitleId, string title, Guid videoStoreMemberId, DateTime fromDate, DateTime toDate) {
          VideoTapeId = videoTapeId;
          VideoTitleId = videoTitleId;
          Title = title;
        ...
        protected bool Equals(RentedVideoTape other) {
          return VideoTapeId.Equals(other.VideoTapeId) && string.Equals(Title, other.Title) && VideoTitleId.Equals(other.VideoTitleId) && VideoStoreMemberId.Equals(other.VideoStoreMemberId) && FromDate.Equals(other.FromDate) && ToDate.Equals(other.ToDate);
        }
